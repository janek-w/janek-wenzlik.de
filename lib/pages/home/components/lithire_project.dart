...
class LithireProject extends StatelessWidget {
  @override
  ...
  Widget _buildUi(double width) {
    // On desktop the original layout showed text first and image second.
    // We keep the same ordering by setting imageOnRightOnDesktop = true.
    return Center(
      child: Container(
        width: width,
        child: ProjectCard(
